 ...
 */
public class RRMoCItemProviderHeartDarkness extends RRMoCItemProvider implements RRMoCItemFoodProvider
{
    /**
     * Return the properties of
     * {@link mestretramador.rrmocreatures.item.RRMoCItemHeartDarkness Heart of
     * Darkness}.
     */
    @Override
    ...
    public Food provideFoodProperties()
    {
        ...
        provideEffectsOfDarkness().forEach((effect) -> {
