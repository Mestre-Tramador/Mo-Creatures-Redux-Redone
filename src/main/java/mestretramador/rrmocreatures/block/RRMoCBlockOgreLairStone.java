...
{                                                                                                                  
    ...
    {                                                                                                              
        setBlock(new Block(((RRMoCBlockItemProviderOgreLairStone) provider).provideBlockProperties()));                  
    }                                                                                                              
    ...
    {                                                                                                              
        return new BlockItem(returnAsBlock(), ((RRMoCBlockItemProviderOgreLairStone) provider).provideItemProperties()); 
    }                                                                                                              
}                                                                                                                  
