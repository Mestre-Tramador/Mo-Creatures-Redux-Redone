...
{                                                                                                                  
    ...
    {                                                                                                              
        setBlock(new Block(((RRMoCBlockItemProviderWyvernLairPlanks) provider).provideBlockProperties()));                  
    }                                                                                                              
    ...
    {                                                                                                              
        return new BlockItem(returnAsBlock(), ((RRMoCBlockItemProviderWyvernLairPlanks) provider).provideItemProperties()); 
    }                                                                                                              
}                                                                                                                  
