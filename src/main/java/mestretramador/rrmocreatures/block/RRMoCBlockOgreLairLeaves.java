...
{                                                                                                                  
    ...
    {                                                                                                              
        setBlock(new Block(((RRMoCBlockItemProviderOgreLairLeaves) provider).provideBlockProperties()));                  
    }                                                                                                              
    ...
    {                                                                                                              
        return new BlockItem(returnAsBlock(), ((RRMoCBlockItemProviderOgreLairLeaves) provider).provideItemProperties()); 
    }                                                                                                              
}                                                                                                                  
