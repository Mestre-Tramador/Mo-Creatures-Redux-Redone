...
public abstract class RRMoCBlockStateProvider extends BlockStateProvider
{
    ...
    /**
     * To create a Block States, besides providing a DataGenerator and
     * a ExistingFileHelper, there is need to pass the block registered.
     ...
     * @param registeredBlock Pass the Block from the {@link mestretramador.rrmocreatures.init.RegisterBlock Registration class}.
     */
