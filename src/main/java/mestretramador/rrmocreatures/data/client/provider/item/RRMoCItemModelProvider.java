...
public abstract class RRMoCItemModelProvider extends RRMoCModelProvider
{
    ...
    /**
     * To create an Item Model, besides providing a DataGenerator and
     * a ExistingFileHelper, there is still need to pass the item model ID and
     * its path, also a layer. The Location is automatically loaded.
