...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Fish Net item model.                                                        
 *                                                                                                       
 * @version 0.0.17                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelFishNet extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Fish Net.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelFishNet(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.FISH_NET, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
