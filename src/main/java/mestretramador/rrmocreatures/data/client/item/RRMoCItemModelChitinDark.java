...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Dark Chitin item model.                                                        
 *                                                                                                       
 * @version 0.0.22                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinDark extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Dark Chitin.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinDark(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_DARK, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
