...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Nether Sting item model.                                                        
 *                                                                                                       
 * @version 0.0.26                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelStingNether extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Nether Sting.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelStingNether(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.STING_NETHER, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
