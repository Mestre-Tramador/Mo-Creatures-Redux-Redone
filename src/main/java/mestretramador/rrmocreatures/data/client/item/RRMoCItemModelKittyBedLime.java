...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Lime Kitty Bed item model.                                                        
 *                                                                                                       
 * @version 0.028                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyBedLime extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Lime Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedLime(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_LIME, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
