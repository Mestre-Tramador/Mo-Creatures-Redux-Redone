...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Frost Chitin Chest item model.                                                        
 *                                                                                                       
 * @version 0.0.24                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinFrostChest extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Frost Chitin Chest.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinFrostChest(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_FROST_CHEST, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
