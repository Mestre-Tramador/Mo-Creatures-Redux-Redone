...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Nether Chitin item model.                                                        
 *                                                                                                       
 * @version 0.0.26                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinNether extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Nether Chitin.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinNether(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_NETHER, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
