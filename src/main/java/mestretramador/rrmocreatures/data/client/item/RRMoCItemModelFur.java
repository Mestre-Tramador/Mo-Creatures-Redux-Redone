...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Fur item model.                                                        
 *                                                                                                       
 * @version 0.0.17                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelFur extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Fur.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelFur(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.FUR, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
