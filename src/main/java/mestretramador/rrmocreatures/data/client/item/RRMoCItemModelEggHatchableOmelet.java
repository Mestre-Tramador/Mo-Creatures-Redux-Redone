...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Omelet item model.                                                        
 *                                                                                                       
 * @version 0.0.21                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelEggHatchableOmelet extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Omelet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelEggHatchableOmelet(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.EGG_HATCHABLE_OMELET, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
