...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Dirt Chitin item model.                                                        
 *                                                                                                       
 * @version 0.0.15                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinDirt extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Dirt Chitin.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinDirt(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_DIRT, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
