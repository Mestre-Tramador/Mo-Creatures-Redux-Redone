...
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Light Blue Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedLightBlue(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_LIGHT_BLUE, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
