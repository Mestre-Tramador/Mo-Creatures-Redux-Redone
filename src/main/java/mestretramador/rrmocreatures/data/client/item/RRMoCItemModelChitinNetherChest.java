...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Nether Chitin Chest item model.                                                        
 *                                                                                                       
 * @version 0.0.25                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinNetherChest extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Nether Chitin Chest.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinNetherChest(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_NETHER_CHEST, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
