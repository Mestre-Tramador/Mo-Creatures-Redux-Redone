...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Hide Legs item model.                                                        
 *                                                                                                       
 * @version 0.0.11                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHideLegs extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Hide Legs.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHideLegs(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HIDE_LEGS, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
