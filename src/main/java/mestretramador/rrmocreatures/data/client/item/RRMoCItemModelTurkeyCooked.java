...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Cooked Turkey item model.                                                        
 *                                                                                                       
 * @version 0.0.23                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelTurkeyCooked extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Cooked Turkey.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelTurkeyCooked(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.TURKEY_COOKED, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
