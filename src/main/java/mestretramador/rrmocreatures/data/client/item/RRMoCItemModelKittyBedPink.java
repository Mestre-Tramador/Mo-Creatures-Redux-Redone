...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Pink Kitty Bed item model.                                                        
 *                                                                                                       
 * @version 0.0.10                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyBedPink extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Pink Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedPink(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_PINK, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
