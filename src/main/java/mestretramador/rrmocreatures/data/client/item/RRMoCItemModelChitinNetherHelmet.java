...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Nether Chitin Helmet item model.                                                        
 *                                                                                                       
 * @version 0.0.25                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinNetherHelmet extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Nether Chitin Helmet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinNetherHelmet(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_NETHER_HELMET, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
