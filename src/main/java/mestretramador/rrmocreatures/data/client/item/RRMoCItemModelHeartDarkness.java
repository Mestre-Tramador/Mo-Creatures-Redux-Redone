...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Heart of Darkness item model.                                                        
 *                                                                                                       
 * @version 0.0.13                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHeartDarkness extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Heart of Darkness.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHeartDarkness(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HEART_DARKNESS, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
