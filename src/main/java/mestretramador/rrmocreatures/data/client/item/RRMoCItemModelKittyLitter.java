...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Kitty Litter item model.                                                        
 *                                                                                                       
 * @version 0.0.25                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyLitter extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Kitty Litter.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyLitter(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_LITTER, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
