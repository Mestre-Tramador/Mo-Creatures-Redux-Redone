...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Essence of Darkness item model.                                                        
 *                                                                                                       
 * @version 0.0.17                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelEssenceDarkness extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Essence of Darkness.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelEssenceDarkness(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.ESSENCE_DARKNESS, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
