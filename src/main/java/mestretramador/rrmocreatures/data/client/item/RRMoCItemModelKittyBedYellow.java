...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Yellow Kitty Bed item model.                                                        
 *                                                                                                       
 * @version 0.0.27                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyBedYellow extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Yellow Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedYellow(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_YELLOW, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
