...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Dirt Sting item model.                                                        
 *                                                                                                       
 * @version 0.0.27                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelStingDirt extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Dirt Sting.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelStingDirt(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.STING_DIRT, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
