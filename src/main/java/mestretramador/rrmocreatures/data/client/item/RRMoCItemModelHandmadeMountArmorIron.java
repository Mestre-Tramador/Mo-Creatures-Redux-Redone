...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Handmade Iron Mount Armor item model.                                                        
 *                                                                                                       
 * @version 0.0.15                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHandmadeMountArmorIron extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Handmade Iron Mount Armor.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHandmadeMountArmorIron(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HANDMADE_MOUNT_ARMOR_IRON, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
