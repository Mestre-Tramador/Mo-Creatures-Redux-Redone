...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Rat Burger item model.                                                        
 *                                                                                                       
 * @version 0.0.24                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelRatBurger extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Rat Burger.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelRatBurger(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.RAT_BURGER, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
