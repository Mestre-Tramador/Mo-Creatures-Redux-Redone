...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Bo item model.                                                        
 *                                                                                                       
 * @version 0.0.16                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelTMNTBo extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Bo.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelTMNTBo(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.TMNT_BO, Constants.ITEM_PATH, "layer0");    
