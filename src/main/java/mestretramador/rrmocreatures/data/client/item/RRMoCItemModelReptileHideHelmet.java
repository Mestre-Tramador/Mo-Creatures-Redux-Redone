...
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Reptile Hide Helmet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelReptileHideHelmet(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.REPTILE_HIDE_HELMET, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
