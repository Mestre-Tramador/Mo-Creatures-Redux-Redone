...
/**                                                                                                      
 * Mo'Creatures Redux&Redone BigCat Claw item model.                                                        
 *                                                                                                       
 * @version 0.0.23                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelBigCatClaw extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a BigCat Claw.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelBigCatClaw(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.BIGCAT_CLAW, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
