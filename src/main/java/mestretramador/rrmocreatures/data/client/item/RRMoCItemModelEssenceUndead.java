...
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Essence of the Undead.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelEssenceUndead(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.ESSENCE_UNDEAD, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
