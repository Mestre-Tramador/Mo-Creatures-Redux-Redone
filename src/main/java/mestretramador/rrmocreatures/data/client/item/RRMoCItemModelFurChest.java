...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Fur Chest item model.                                                        
 *                                                                                                       
 * @version 0.0.21                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelFurChest extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Fur Chest.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelFurChest(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.FUR_CHEST, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
