...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Key item model.                                                        
 *                                                                                                       
 * @version 0.0.22                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKey extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Key.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKey(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KEY, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
