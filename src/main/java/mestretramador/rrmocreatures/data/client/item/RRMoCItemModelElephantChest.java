...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Elephant Saddlebag item model.                                                        
 *                                                                                                       
 * @version 0.0.21                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelElephantChest extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Elephant Saddlebag.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelElephantChest(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.ELEPHANT_CHEST, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
