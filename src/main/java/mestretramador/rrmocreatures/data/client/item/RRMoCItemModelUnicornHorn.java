...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Unicorn Horn item model.                                                        
 *                                                                                                       
 * @version 0.0.22                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelUnicornHorn extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Unicorn Horn.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelUnicornHorn(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.UNICORN_HORN, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
