...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Hatchable Egg item model.                                                        
 *                                                                                                       
 * @version 0.0.16                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelEggHatchable extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Hatchable Egg.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelEggHatchable(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.EGG_HATCHABLE, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
