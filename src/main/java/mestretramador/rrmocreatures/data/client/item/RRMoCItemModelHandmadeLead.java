...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Handmade Lead item model.                                                        
 *                                                                                                       
 * @version 0.0.19                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHandmadeLead extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Handmade Lead.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHandmadeLead(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HANDMADE_LEAD, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
