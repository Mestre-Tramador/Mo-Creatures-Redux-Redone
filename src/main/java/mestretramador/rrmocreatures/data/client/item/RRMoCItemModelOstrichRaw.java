...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Raw Ostrich item model.                                                        
 *                                                                                                       
 * @version 0.0.16                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelOstrichRaw extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Raw Ostrich.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelOstrichRaw(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.OSTRICH_RAW, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
