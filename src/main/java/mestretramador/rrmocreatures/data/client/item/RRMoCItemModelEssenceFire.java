...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Essence of Fire item model.                                                        
 *                                                                                                       
 * @version 0.0.11                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelEssenceFire extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Essence of Fire.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelEssenceFire(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.ESSENCE_FIRE, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
