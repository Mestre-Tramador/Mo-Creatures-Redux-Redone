...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Raw Turkey item model.                                                        
 *                                                                                                       
 * @version 0.0.27                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelTurkeyRaw extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Raw Turkey.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelTurkeyRaw(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.TURKEY_RAW, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
