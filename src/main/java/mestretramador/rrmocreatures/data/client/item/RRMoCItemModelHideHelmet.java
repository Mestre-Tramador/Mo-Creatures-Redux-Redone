...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Hide Helmet item model.                                                        
 *                                                                                                       
 * @version 0.0.14                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHideHelmet extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Hide Helmet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHideHelmet(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HIDE_HELMET, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
