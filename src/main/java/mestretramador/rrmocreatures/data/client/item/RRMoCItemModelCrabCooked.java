...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Cooked Crab item model.                                                        
 *                                                                                                       
 * @version 0.0.27                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelCrabCooked extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Cooked Crab.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelCrabCooked(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CRAB_COOKED, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
