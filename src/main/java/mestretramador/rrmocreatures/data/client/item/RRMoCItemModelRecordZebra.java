...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Music Disc - Zebra item model.                                                        
 *                                                                                                       
 * @version 0.0.14                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelRecordZebra extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Music Disc - Zebra.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelRecordZebra(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.RECORD_ZEBRA, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
