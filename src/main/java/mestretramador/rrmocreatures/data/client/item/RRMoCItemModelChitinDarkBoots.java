...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Dark Chitin Boots item model.                                                        
 *                                                                                                       
 * @version 0.0.17                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinDarkBoots extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Dark Chitin Boots.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinDarkBoots(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_DARK_BOOTS, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
