...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Reptile Hide Boots item model.                                                        
 *                                                                                                       
 * @version 0.0.22                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelReptileHideBoots extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Reptile Hide Boots.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelReptileHideBoots(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.REPTILE_HIDE_BOOTS, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
