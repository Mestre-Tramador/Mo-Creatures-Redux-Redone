...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Indian Elephant Garment item model.                                                        
 *                                                                                                       
 * @version 0.0.12                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelElephantIndianGarment extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Indian Elephant Garment.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelElephantIndianGarment(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.ELEPHANT_INDIAN_GARMENT, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
