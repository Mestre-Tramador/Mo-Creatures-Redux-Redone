...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Dark Chitin Legs item model.                                                        
 *                                                                                                       
 * @version 0.0.9                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinDarkLegs extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Dark Chitin Legs.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinDarkLegs(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_DARK_LEGS, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
