...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Blank Scroll item model.                                                        
 *                                                                                                       
 * @version 0.0.13                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelScrollBlank extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Blank Scroll.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelScrollBlank(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.SCROLL_BLANK, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
