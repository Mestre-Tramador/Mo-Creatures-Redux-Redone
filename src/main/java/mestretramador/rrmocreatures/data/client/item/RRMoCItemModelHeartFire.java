...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Heart of Fire item model.                                                        
 *                                                                                                       
 * @version 0.0.29                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHeartFire extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Heart of Fire.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHeartFire(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HEART_FIRE, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
