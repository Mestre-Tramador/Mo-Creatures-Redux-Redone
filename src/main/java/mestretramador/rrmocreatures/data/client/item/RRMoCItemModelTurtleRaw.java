...
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Raw Turtle.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelTurtleRaw(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.TURTLE_RAW, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
