...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Frost Sting item model.                                                        
 *                                                                                                       
 * @version 0.0.27                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelStingFrost extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Frost Sting.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelStingFrost(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.STING_FROST, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
