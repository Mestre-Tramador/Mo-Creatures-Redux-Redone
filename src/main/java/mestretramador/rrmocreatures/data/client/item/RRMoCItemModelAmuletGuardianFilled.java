...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Filled Guardian Amulet item model.                                                        
 *                                                                                                       
 * @version 0.0.20                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelAmuletGuardianFilled extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Filled Guardian Amulet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelAmuletGuardianFilled(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.AMULET_GUARDIAN_FILLED, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
