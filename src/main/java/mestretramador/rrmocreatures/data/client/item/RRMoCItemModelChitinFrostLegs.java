...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Frost Chitin Legs item model.                                                        
 *                                                                                                       
 * @version 0.0.21                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinFrostLegs extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Frost Chitin Legs.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinFrostLegs(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_FROST_LEGS, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
