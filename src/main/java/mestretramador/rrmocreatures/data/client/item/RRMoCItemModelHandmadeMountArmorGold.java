...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Handmade Gold Mount Armor item model.                                                        
 *                                                                                                       
 * @version 0.028                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHandmadeMountArmorGold extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Handmade Gold Mount Armor.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHandmadeMountArmorGold(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HANDMADE_MOUNT_ARMOR_GOLD, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
