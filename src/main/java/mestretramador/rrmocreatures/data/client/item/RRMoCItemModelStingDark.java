...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Dark Sting item model.                                                        
 *                                                                                                       
 * @version 0.0.14                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelStingDark extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Dark Sting.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelStingDark(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.STING_DARK, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
