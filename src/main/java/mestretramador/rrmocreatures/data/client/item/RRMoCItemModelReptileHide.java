...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Reptile Hide item model.                                                        
 *                                                                                                       
 * @version 0.0.18                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelReptileHide extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Reptile Hide.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelReptileHide(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.REPTILE_HIDE, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
