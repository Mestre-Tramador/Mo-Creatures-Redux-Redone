...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Magenta Kitty Bed item model.                                                        
 *                                                                                                       
 * @version 0.0.20                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyBedMagenta extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Magenta Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedMagenta(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_MAGENTA, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
