...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Kitty Food item model.                                                        
 *                                                                                                       
 * @version 0.0.25                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyFood extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Kitty Food.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyFood(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_FOOD, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
