...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Scroll - Freedom item model.                                                        
 *                                                                                                       
 * @version 0.0.26                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelScrollFreedom extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Scroll - Freedom.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelScrollFreedom(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.SCROLL_FREEDOM, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
