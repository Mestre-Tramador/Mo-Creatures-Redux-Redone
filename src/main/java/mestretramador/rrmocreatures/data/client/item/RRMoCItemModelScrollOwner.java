...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Scroll - Owner item model.                                                        
 *                                                                                                       
 * @version 0.0.26                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelScrollOwner extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Scroll - Owner.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelScrollOwner(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.SCROLL_OWNER, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
