...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Hide Boots item model.                                                        
 *                                                                                                       
 * @version 0.0.10                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHideBoots extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Hide Boots.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHideBoots(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HIDE_BOOTS, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
