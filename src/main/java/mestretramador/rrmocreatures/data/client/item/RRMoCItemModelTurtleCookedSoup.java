...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Turtle Soup item model.                                                        
 *                                                                                                       
 * @version 0.0.11                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelTurtleCookedSoup extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Turtle Soup.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelTurtleCookedSoup(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.TURTLE_COOKED_SOUP, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
