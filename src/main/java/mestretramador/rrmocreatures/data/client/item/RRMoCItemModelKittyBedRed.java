...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Red Kitty Bed item model.                                                        
 *                                                                                                       
 * @version 0.0.19                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyBedRed extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Red Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedRed(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_RED, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
