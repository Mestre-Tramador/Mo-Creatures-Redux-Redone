...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Reptile Hide Chest item model.                                                        
 *                                                                                                       
 * @version 0.0.9                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelReptileHideChest extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Reptile Hide Chest.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelReptileHideChest(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.REPTILE_HIDE_CHEST, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
