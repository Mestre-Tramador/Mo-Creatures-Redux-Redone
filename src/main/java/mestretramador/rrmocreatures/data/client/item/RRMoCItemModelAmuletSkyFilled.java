...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Filled Sky Amulet item model.                                                        
 *                                                                                                       
 * @version 0.0.23                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelAmuletSkyFilled extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Filled Sky Amulet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelAmuletSkyFilled(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.AMULET_SKY_FILLED, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
