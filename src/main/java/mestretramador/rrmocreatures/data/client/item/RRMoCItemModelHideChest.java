...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Hide Chest item model.                                                        
 *                                                                                                       
 * @version 0.0.13                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHideChest extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Hide Chest.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHideChest(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HIDE_CHEST, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
