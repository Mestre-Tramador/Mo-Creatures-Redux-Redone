...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Guardian Amulet item model.                                                        
 *                                                                                                       
 * @version 0.028                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelAmuletGuardian extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Guardian Amulet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelAmuletGuardian(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.AMULET_GUARDIAN, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
