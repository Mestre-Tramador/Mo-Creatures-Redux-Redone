...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Wyvern Lair Tall GRass item model.                                                        
 *                                                                                                       
 * @version 0.0.22                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelWyvernLairTallGrass extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Wyvern Lair Tall GRass.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelWyvernLairTallGrass(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Blocks.WYVERN_LAIR_TALL_GRASS, Constants.BLOCK_PATH, "layer0");      
    }                                                                                                    
