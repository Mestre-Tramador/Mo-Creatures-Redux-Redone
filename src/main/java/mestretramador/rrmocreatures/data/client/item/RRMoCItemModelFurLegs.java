...
/**                                                                                                      
 * Mo'Creatures Redux&Redone FurLegs item model.                                                        
 *                                                                                                       
 * @version 0.0.11                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelFurLegs extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a FurLegs.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelFurLegs(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.FUR_LEGS, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
