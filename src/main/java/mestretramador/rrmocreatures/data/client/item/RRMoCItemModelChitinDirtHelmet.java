...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Dirt Chitin Helmet item model.                                                        
 *                                                                                                       
 * @version 0.0.13                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinDirtHelmet extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Dirt Chitin Helmet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinDirtHelmet(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_DIRT_HELMET, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
