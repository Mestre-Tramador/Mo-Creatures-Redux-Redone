...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Handmade Crystal Mount Armor item model.                                                        
 *                                                                                                       
 * @version 0.0.22                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHandmadeMountArmorCrystal extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Handmade Crystal Mount Armor.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHandmadeMountArmorCrystal(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HANDMADE_MOUNT_ARMOR_CRYSTAL, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
