...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Frost Chitin item model.                                                        
 *                                                                                                       
 * @version 0.0.23                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinFrost extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Frost Chitin.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinFrost(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_FROST, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
