...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Staff - Diamond item model.                                                        
 *                                                                                                       
 * @version 0.0.19                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelStaffDiamond extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Staff - Diamond.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelStaffDiamond(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.STAFF_DIAMOND, Constants.ITEM_PATH, "layer0");  
