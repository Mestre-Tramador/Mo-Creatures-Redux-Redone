...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Nether Chitin Boots item model.                                                        
 *                                                                                                       
 * @version 0.0.25                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinNetherBoots extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Nether Chitin Boots.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinNetherBoots(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_NETHER_BOOTS, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
