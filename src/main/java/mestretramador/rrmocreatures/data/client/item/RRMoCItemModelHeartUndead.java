...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Heart of the Undead item model.                                                        
 *                                                                                                       
 * @version 0.0.22                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHeartUndead extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Heart of the Undead.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHeartUndead(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HEART_UNDEAD, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
