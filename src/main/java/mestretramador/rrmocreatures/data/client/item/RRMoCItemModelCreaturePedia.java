...
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Creaturepedia.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelCreaturePedia(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CREATURE_PEDIA, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
