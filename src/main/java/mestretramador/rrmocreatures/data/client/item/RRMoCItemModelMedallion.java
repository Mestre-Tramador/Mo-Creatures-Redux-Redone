...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Medallion item model.                                                        
 *                                                                                                       
 * @version 0.0.23                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelMedallion extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Medallion.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelMedallion(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.MEDALLION, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
