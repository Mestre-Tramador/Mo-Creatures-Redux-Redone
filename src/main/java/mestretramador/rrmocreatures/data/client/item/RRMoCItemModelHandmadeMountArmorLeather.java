...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Handmade Leather Mount Armor item model.                                                        
 *                                                                                                       
 * @version 0.0.23                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHandmadeMountArmorLeather extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Handmade Leather Mount Armor.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHandmadeMountArmorLeather(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HANDMADE_MOUNT_ARMOR_LEATHER, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
