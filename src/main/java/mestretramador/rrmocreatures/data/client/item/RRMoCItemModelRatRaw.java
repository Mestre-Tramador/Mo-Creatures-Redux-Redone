...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Raw Rat item model.                                                        
 *                                                                                                       
 * @version 0.0.19                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelRatRaw extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Raw Rat.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelRatRaw(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.RAT_RAW, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
