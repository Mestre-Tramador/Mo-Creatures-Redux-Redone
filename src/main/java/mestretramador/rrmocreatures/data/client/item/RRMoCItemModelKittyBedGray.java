...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Gray Kitty Bed item model.                                                        
 *                                                                                                       
 * @version 0.0.25                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyBedGray extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Gray Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedGray(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_GRAY, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
