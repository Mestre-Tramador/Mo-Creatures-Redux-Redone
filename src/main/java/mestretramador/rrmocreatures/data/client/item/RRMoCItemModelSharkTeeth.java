...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Shark Teeth item model.                                                        
 *                                                                                                       
 * @version 0.0.9                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelSharkTeeth extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Shark Teeth.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelSharkTeeth(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.SHARK_TEETH, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
