...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Kitty Wool Ball item model.                                                        
 *                                                                                                       
 * @version 0.0.29                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyWoolBall extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Kitty Wool Ball.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyWoolBall(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_WOOL_BALL, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
