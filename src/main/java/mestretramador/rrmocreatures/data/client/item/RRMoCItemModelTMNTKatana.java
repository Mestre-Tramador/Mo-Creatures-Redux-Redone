...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Katana item model.                                                        
 *                                                                                                       
 * @version 0.0.12                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelTMNTKatana extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Katana.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelTMNTKatana(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.TMNT_KATANA, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
