...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Blue Kitty Bed item model.                                                        
 *                                                                                                       
 * @version 0.0.18                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyBedBlue extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Blue Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedBlue(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_BLUE, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
