...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Sky Amulet item model.                                                        
 *                                                                                                       
 * @version 0.0.17                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelAmuletSky extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Sky Amulet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelAmuletSky(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.AMULET_SKY, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
