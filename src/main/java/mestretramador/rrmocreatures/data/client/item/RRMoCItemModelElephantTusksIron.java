...
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Iron Elephant Tusk Sword.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelElephantTusksIron(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.ELEPHANT_TUSKS_IRON, Constants.ITEM_PATH, "layer0");
