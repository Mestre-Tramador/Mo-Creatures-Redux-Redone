...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Handmade Diamond Mount Armor item model.                                                        
 *                                                                                                       
 * @version 0.0.15                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHandmadeMountArmorDiamond extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Handmade Diamond Mount Armor.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHandmadeMountArmorDiamond(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HANDMADE_MOUNT_ARMOR_DIAMOND, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
