...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Handmade Saddlebag item model.                                                        
 *                                                                                                       
 * @version 0.0.18                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHandmadeSaddleChest extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Handmade Saddlebag.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHandmadeSaddleChest(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HANDMADE_SADDLE_CHEST, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
