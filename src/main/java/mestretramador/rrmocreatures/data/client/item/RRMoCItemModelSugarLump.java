...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Sugar Lumps item model.                                                        
 *                                                                                                       
 * @version 0.0.17                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelSugarLump extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Sugar Lumps.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelSugarLump(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.SUGAR_LUMP, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
