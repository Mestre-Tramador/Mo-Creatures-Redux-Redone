...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Bone Amulet item model.                                                        
 *                                                                                                       
 * @version 0.0.14                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelAmuletBone extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Bone Amulet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelAmuletBone(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.AMULET_BONE, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
