...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Frost Chitin Helmet item model.                                                        
 *                                                                                                       
 * @version 0.0.29                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinFrostHelmet extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Frost Chitin Helmet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinFrostHelmet(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_FROST_HELMET, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
