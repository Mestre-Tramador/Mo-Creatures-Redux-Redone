...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Dark Chitin Helmet item model.                                                        
 *                                                                                                       
 * @version 0.0.26                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinDarkHelmet extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Dark Chitin Helmet.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinDarkHelmet(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_DARK_HELMET, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
