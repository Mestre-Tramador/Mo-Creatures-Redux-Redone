...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Purple Kitty Bed item model.                                                        
 *                                                                                                       
 * @version 0.0.10                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyBedPurple extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Purple Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedPurple(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_PURPLE, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
