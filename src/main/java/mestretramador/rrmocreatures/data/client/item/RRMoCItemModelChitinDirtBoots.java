...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Dirt Chitin Boots item model.                                                        
 *                                                                                                       
 * @version 0.0.9                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinDirtBoots extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Dirt Chitin Boots.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinDirtBoots(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_DIRT_BOOTS, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
