...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Black Kitty Bed item model.                                                        
 *                                                                                                       
 * @version 0.0.15                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyBedBlack extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Black Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedBlack(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_BLACK, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
