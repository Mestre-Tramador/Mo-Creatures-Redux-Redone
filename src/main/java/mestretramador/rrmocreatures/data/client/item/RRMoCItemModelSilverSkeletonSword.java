...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Silver Skeleton Sword item model.                                                        
 *                                                                                                       
 * @version 0.0.12                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelSilverSkeletonSword extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Silver Skeleton Sword.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelSilverSkeletonSword(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.SILVER_SKELETON_SWORD, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
