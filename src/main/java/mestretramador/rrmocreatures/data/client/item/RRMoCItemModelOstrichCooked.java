...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Cooked Ostrich item model.                                                        
 *                                                                                                       
 * @version 0.0.19                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelOstrichCooked extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Cooked Ostrich.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelOstrichCooked(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.OSTRICH_COOKED, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
