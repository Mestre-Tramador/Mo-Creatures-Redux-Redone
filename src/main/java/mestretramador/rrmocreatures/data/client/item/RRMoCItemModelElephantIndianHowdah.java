...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Indian Elephant Howdah item model.                                                        
 *                                                                                                       
 * @version 0.0.27                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelElephantIndianHowdah extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Indian Elephant Howdah.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelElephantIndianHowdah(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.ELEPHANT_INDIAN_HOWDAH, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
