...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Green Kitty Bed item model.                                                        
 *                                                                                                       
 * @version 0.0.20                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyBedGreen extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Green Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedGreen(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_GREEN, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
