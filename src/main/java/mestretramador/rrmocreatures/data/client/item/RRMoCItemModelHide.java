...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Hide item model.                                                        
 *                                                                                                       
 * @version 0.0.29                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelHide extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Hide.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelHide(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.HIDE, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
