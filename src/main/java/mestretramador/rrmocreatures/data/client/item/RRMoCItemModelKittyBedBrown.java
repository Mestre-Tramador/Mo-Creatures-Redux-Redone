...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Brown Kitty Bed item model.                                                        
 *                                                                                                       
 * @version 0.0.18                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelKittyBedBrown extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Brown Kitty Bed.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelKittyBedBrown(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.KITTY_BED_BROWN, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
