...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Scroll - Saleitem model.                                                        
 *                                                                                                       
 * @version 0.0.17                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelScrollSale extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Scroll - Sale.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelScrollSale(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.SCROLL_SALE, Constants.ITEM_PATH, "layer0");       
    }                                                                                                    
