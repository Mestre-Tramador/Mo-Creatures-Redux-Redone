...
/**                                                                                                      
 * Mo'Creatures Redux&Redone Dark Chitin Chest item model.                                                        
 *                                                                                                       
 * @version 0.0.10                                                                                    
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                                      
 */                                                                                                      
public class RRMoCItemModelChitinDarkChest extends RRMoCItemModelProvider                                        
{                                                                                                        
    /**                                                                                                  
     * Using the parent constructor, create a Dark Chitin Chest.                                                    
     *                                                                                                   
     ...
     */                                                                                                  
    public RRMoCItemModelChitinDarkChest(DataGenerator generator, ExistingFileHelper existingFileHelper)         
    {                                                                                                    
        super(generator, existingFileHelper, Constants.Items.CHITIN_DARK_CHEST, Constants.ITEM_PATH, "layer0");      
    }                                                                                                    
