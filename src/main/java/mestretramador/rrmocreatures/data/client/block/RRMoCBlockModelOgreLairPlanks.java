...
{                                                                                                 
    /**                                                                                           
     * Using the parent constructor, create a Ogre Lair Planks.                                             
     *                                                                                            
     ...
     */                                                                                           
    public RRMoCBlockModelOgreLairPlanks(DataGenerator generator, ExistingFileHelper existingFileHelper) 
    {                                                                                             
        super(generator, existingFileHelper, Constants.Blocks.OGRE_LAIR_PLANKS, Constants.BLOCK_PATH);        
    }                                                                                             
