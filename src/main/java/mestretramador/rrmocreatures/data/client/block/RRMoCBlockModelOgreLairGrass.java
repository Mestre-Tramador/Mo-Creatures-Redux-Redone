...
/**                                                                                               
 * Mo'Creatures Redux&Redone Ogre Lair Grass block model.                                                
 *                                                                                                
 * @version 0.0.12                                                                             
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                               
 */                                                                                               
public class RRMoCBlockModelOgreLairGrass extends RRMoCBlockModelProvider                               
{                                                                                                 
    /**                                                                                           
     * Using the parent constructor, create a Ogre Lair Grass.                                             
     *                                                                                            
     ...
     */                                                                                           
    public RRMoCBlockModelOgreLairGrass(DataGenerator generator, ExistingFileHelper existingFileHelper) 
    {                                                                                             
        super(generator, existingFileHelper, Constants.Blocks.OGRE_LAIR_GRASS, Constants.BLOCK_PATH);        
    }                                                                                             
