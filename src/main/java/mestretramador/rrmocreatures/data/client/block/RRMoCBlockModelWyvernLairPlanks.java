...
/**                                                                                               
 * Mo'Creatures Redux&Redone Wyvern Lair Planks block model.                                                
 *                                                                                                
 * @version 0.0.18                                                                             
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                               
 */                                                                                               
public class RRMoCBlockModelWyvernLairPlanks extends RRMoCBlockModelProvider                               
{                                                                                                 
    /**                                                                                           
     * Using the parent constructor, create a Wyvern Lair Planks.                                             
     *                                                                                            
     ...
     */                                                                                           
    public RRMoCBlockModelWyvernLairPlanks(DataGenerator generator, ExistingFileHelper existingFileHelper) 
    {                                                                                             
        super(generator, existingFileHelper, Constants.Blocks.WYVERN_LAIR_PLANKS, Constants.BLOCK_PATH);        
    }                                                                                             
