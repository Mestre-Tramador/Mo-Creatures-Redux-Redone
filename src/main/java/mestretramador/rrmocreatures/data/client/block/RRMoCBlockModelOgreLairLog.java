...
/**                                                                                               
 * Mo'Creatures Redux&Redone Ogre Lair Log block model.                                                
 *                                                                                                
 * @version 0.0.13                                                                             
 * @author Eduardo de Oliveira Rosa, Mestre Tramador.                                                                               
 */                                                                                               
public class RRMoCBlockModelOgreLairLog extends RRMoCBlockModelProvider                               
{                                                                                                 
    /**                                                                                           
     * Using the parent constructor, create a Ogre Lair Log.                                             
     *                                                                                            
     ...
     */                                                                                           
    public RRMoCBlockModelOgreLairLog(DataGenerator generator, ExistingFileHelper existingFileHelper) 
    {                                                                                             
        super(generator, existingFileHelper, Constants.Blocks.OGRE_LAIR_LOG, Constants.BLOCK_PATH);        
    }                                                                                             
