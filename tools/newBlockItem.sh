#################################################################
# This batch file creates both BlockItem and Provider classes.
...
echo "                                                                                                                                          " >> "RRMoCBlockItemProvider$class.java"
echo "    /**                                                                                                                                   " >> "RRMoCBlockItemProvider$class.java"
echo "     * Return the block properties of {@link mestretramador.rrmocreatures.block.RRMoCBlockItem$class $name}.                              " >> "RRMoCBlockItemProvider$class.java"
echo "     */                                                                                                                                   " >> "RRMoCBlockItemProvider$class.java"
...
echo "                                                                                                                                          " >> "RRMoCBlockItemProvider$class.java"
echo "    /**                                                                                                                                   " >> "RRMoCBlockItemProvider$class.java"
echo "     * Return the blockitem properties of {@link mestretramador.rrmocreatures.block.RRMoCBlockItem$class $name}.                          " >> "RRMoCBlockItemProvider$class.java"
echo "     */                                                                                                                                   " >> "RRMoCBlockItemProvider$class.java"
