############################################################################
# This shell script file creates an Item Tag Append Generator class.
...
echo "import mestretramador.rrmocreatures.data.common.provider.tags.item.RRMoCItemTagAppendProvider; " >> "RRMoCItemTagAppend$class.java"
